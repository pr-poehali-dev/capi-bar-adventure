...
const Index = () => {
  ...
  const [inventory, setInventory] = useState<Array<{id: number, name: string, foundBy: string}>>([]);
              ...
              <div className="min-h-[300px]">
                {inventory.length === 0 ? (
                  ...
                  <ul className="space-y-3">
                    {inventory.map(item => (
                      <li key={item.id} className="p-3 bg-[#f0e9d9] rounded-lg border border-[#d5b89a]">
